...
> Answer: Client-side routing allows control over our content without having to wait on the server to send back information.
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript And XML
- [ ] What are `controlled components` in React?
> Answer: Controlled Components take their value through props and changes through callbacks.
